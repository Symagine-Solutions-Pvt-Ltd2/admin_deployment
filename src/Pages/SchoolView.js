...

{
            ...
            <div    className="clientview_table_row_box"   style= {{   width: "18%"  ,    height: "100%"   ,  display: "flex"  ,   flexDirection : "row"  , justifyContent  : 'space-around'  , borderRight : "1px solid #B6B7D0" }}> 
